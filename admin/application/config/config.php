...
|
*/
$config['base_url'] = 'https://localhost/marketplacex/admin/';
$config['assets_produk'] = $_SERVER["DOCUMENT_ROOT"]."/marketplacex/assets/produk/";
$config['url_produk'] = 'https://localhost/marketplacex/assets/produk/';
